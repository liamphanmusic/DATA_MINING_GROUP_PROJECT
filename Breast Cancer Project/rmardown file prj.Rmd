...
#### Logistic Regression with VIF removing 8 variables - First Iteration

```{r Logistic Regression after VIF - 1}
...
#### Logistic Regression with VIF removing 6 variables - Second Iteration
...
#### Logistic Regression with VIF removing 6 variables - Fifth Iteration (Last)
...
# Create horizontal bar chart to display each VIF value
barplot(vif_values_5, main = "VIF Values - Fourth Iteration", horiz = FALSE, col = "steelblue", las=2)
...
### Advanced Neural Network with Optimal Number of Hidden Nodes - Model 2
...
### Advanced Neural Network with 2 Hidden Layers and 15 Hidden Nodes - Model 3
