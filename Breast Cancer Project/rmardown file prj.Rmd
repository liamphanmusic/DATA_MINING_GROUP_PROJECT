...
draw_confusion_matrix_Neural_1 <- function(cm) {
  ...
  par(mar=c(2,2,2,2))
  plot(c(100, 345), c(300, 450), type = "n", xlab="", ylab="", xaxt='n', yaxt='n')
  title('CONFUSION MATRIX for Neural Network - 3 Hidden Nodes', cex.main=2)
...
# Plot our ROC Curve
prNN1 <- ROCR::prediction(Predictions_NN1_Probabilities, Validation_NN_Preprocess$diagnosis)
prfNN1 <- ROCR::performance(prNN1, measure = "tpr", x.measure = "fpr")
plot(prfNN1, main="ROC for Validation Set")
abline(a = 0, b = 1) 
...
# Plot our ROC Curve 
prNN2 <- ROCR::prediction(Predictions_NN2_Probabilities, Validation_NN_Preprocess$diagnosis)
prfNN2 <- ROCR::performance(prNN2, measure = "tpr", x.measure = "fpr")
plot(prfNN2, main="ROC for Validation Set")
abline(a = 0, b = 1) 
