...
#####  Proportions of T1 and T2 (Hypothesis) 
...
ggplot(Pie_T1_T2, aes(x="", y=n, fill=t)) +
  ...
  labs(x = NULL, y = NULL, fill = "T Category") + scale_fill_manual(values=c("#1c6155","#66807b")) + ggtitle("Pie Chart of T Category Proportions for Malign Breast Tumors")
