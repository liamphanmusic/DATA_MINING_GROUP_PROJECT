...
> Comments: Eventough we did a Lasso Regression, we can see that our standard Logistic Regression fails to converge with this selection of variables. This is could be due to the number of variables, 23 in our case and the low number of observations. 

```{r Logistic Regression after Lasso and AIC}
