...
### Confusion Matrix for Majority and Average Probabilities

```{r Confusion Matrix for Majority and Average Probabilities}
...
## Best 3 Models - On Training

```{r Best 3 Models amongst all, echo=FALSE}
